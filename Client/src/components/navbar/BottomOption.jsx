...
const BottomOption = () => {
  ...
  return (
    <div className="flex px-6 ">
      <div onClick={()=> dispatch(setTeheme(!theme))} className="w-full pl-8 flex justify-center cursor-pointer text-gray-400 ">
      ...
      <div onClick={()=>dispatch(setProfilePop(!profilePop))} className=" w-full flex justify-end items-center cursor-pointer text-gray-400">
